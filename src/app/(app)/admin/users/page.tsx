...
export default async function UsersPage() {
  ...
  return (
    <>
      <PageHeader eyebrow="Administração" title="Usuários" description="Equipe com acesso ao Leto Pipeline. Senhas nunca ficam no código: são definidas aqui ou via `npm run users:create`." />
