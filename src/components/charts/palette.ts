...
export const CHART_COLORS = ["#a6b85a", "#5c7a2e", "#3b6b8f", "#8f5a3b", "#6b4f8f", "#c99a3b", "#2f6b5a", "#9a4b4b", "#7c8aa0", "#4a6f8f", "#8a7a2f", "#d1b25a", "#5aa88a", "#8f3b7a"];
export const LETO_GREEN = "#a6b85a";
export const LETO_GREEN_DEEP = "#5c7a2e";
